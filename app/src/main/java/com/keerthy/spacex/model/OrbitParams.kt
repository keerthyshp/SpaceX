...
data class OrbitParams(
    ...
    @SerializedName("periapsis_km") var periapsisKm: Float? = null,
    @SerializedName("apoapsis_km") var apoapsisKm: Float? = null,
    @SerializedName("inclination_deg") var inclinationDeg: Float? = null,
